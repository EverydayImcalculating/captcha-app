...
import { appendResultsToFile, downloadCSV } from "@/utils/csvHandler";
...
export default function TestPage() {
  ...
  let type: CaptchaType = orderedTypes[0];
  if (currentRound >= 5 && currentRound < 10) type = orderedTypes[1];
  if (currentRound >= 10) type = orderedTypes[2];
