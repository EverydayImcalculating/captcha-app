...
export function SliderCaptcha({ difficulty, onComplete }: SliderCaptchaProps) {
  ...
  React.useEffect(() => {
    ...
    (`https://loremflickr.com/600/300setImageUrl/landscape?lock=${Date.now()}`); // Higher res for responsiveness
             ...
             <>
               ...
               <div 
                 ...
                 style={{ 
                   ...
                   width: `${pieceWidth}px`,
                   height: `${pieceHeight}px`,
                   transform: pieceRotation !== 0 ? `rotate(${pieceRotation}deg)` : undefined,
                 }}
               >
